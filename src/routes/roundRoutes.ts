...
export async function roundRoutes(server: FastifyInstance) {
  /**
   * @deprecated Use /messages/agentMessage instead
   * Legacy AI Chat endpoint kept for backward compatibility
   */
  server.post<{
  ...
  /**
   * End Round Endpoint
   * Closes an active round and processes final state/outcomes
   */
  server.post<{
